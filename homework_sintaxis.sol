...
// modifier para verificar que se envíe suficiente Ether
modifier cost(uint256 amount) {
    require(msg.value >= amount, "No se envi suficiente Ether");
    _;
}
...
function pushData(string memory _date,
    ...
    int8 _status) public payable cost(1000000000000000) { // Cambiado a 1000000000000000
    data = Data(_date,
        _delivery_date,
        _product,
        _price,
